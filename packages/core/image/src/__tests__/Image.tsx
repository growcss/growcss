...
test('Image load small image if no preview image is set', () => {
  ...
  expect(wrapper.find('.gc-image .preview').html()).toEqual(
    '<img class="preview PreviewElement-sc-1t6xf7x-0 iWKQVZ" src="https://ucarecdn.com/1b73ebf8-b2d6-40cc-abd6-945d4df883c9/-/resize/400x/mountain.jpg" crossOrigin="anonymous"/>',
  );
});
