  ...
  .add('GridX vertical top alignment', () => (
    <GridX gutterType="padding" alignY="top">
      ...
      <Cell small={4}>
        ...
        tempora. Impedit eius officia possimus laudantium? Molestiae eaque,
        sapiente atque doloremque placeat! In sint, fugiat saepe sunt dolore
        tempore amet cupiditate.
      </Cell>
    </GridX>
  ))
  ...
  .add('Grid cell with self align types', () => (
    <GridX gutterType="padding">
      ...
      <Cell small={3} align="top">
        Align top. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non
        harum laborum cum voluptate vel, eius adipisci similique dignissimos
        nobis at excepturi incidunt fugit molestiae quaerat, consequuntur porro
        temporibus. Nisi, ex?
      </Cell>
    </GridX>
  ))
