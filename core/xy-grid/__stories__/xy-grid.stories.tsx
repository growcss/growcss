...
storiesOf('Core.XY-Grid.Grid', module)
  ...
  .add('GridX vertical top alignment', () => (
    <GridX gutterType="padding" alignY="top">
      ...
      <Cell small={4}>
        ...
        Impedit eius officia possimus laudantium? Molestiae eaque, sapiente atque
        doloremque placeat! In sint, fugiat saepe sunt dolore tempore amet cupiditate.
      </Cell>
    </GridX>
  ))
  ...
  .add('Grid cell with self align types', () => (
    <GridX gutterType="padding">
      <Cell small={3} align="bottom">
        Align bottom
      </Cell>
      <Cell small={3} align="middle">
        Align middle
      </Cell>
      <Cell small={3} align="stretch">
        Align stretch
      </Cell>
      <Cell small={3} align="top">
        Align top. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non harum
        laborum cum voluptate vel, eius adipisci similique dignissimos nobis at excepturi
        incidunt fugit molestiae quaerat, consequuntur porro temporibus. Nisi, ex?
      </Cell>
    </GridX>
  ))
  ...
  .add(
    'To switch back to the auto behavior from a percentage or shrink behavior',
    () => (
      <GridX>
