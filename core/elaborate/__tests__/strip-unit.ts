import { stripUnit } from '../src/components/strip-unit';
...
describe('Strip units', () => {
  ...
  it('should strip px from minus values', () => {
    expect(stripUnit('-100px')).toBe(-100);
  });
  ...
  it('should strip em from minus values', () => {
    expect(stripUnit('-0.667em')).toBe(-0.667);
  });

  it('should be equal to string 100', () => {
    expect(stripUnit('100')).toBe(100);
  });
  ...
  it('should be equal null', () => {
    expect(() => {
      stripUnit('foo');
    }).toThrow(new Error('An empty string was given for value.'));
  });

  it('should be equal int 100', () => {
    expect(stripUnit(100)).toBe(100);
  });
  ...
  it('should strip px from float values', () => {
  ...
  it('should strip pt from float values', () => {
  ...
  it('should strip pc from float values', () => {
  ...
  it('should strip mm from float values', () => {
  ...
  it('should strip q from float values', () => {
  ...
  it('should strip cm from float values', () => {
  ...
  it('should strip in from float values', () => {
